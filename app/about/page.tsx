...
const page: FC<pageProps> = ({}) => {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* placeholder solo funciona con imagenes importadas */}
      ...
      {/* mostrar una imagen cuando no se conocen las dimensiones de la imagen por ejemplo cuando vienen de una url externa */}
